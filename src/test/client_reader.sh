...
#opens a client and reads everything from input file, outputs to output file,
#checks for differences in outcome, then quits
...
#declare files
file_in = "client_writer_input$1.txt"
file_out_val = "file.txt"
file_out_tst = "diff.txt"

# Loop the array
for file in "${file_base[@]}"; do
    # Padd file_base with suffixes
    file_in="$file.in"             # The in file
    #file_in="client_writer_input$1.txt"     #renamed to input file aka client_writer_inputx
    file_out_val="$file.txt"       # The out file to check against
    #file_out_val="diff.txt"     #renamed to diff file generated by python
    ...
    "./$bin 127.0.0.1" < "$file_in" > "$file_out_tst"
